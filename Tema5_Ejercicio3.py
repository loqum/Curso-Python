...
def encuentra_numero_aleatorio(numero_generado):
  ...
  while (not encontrado):
    ...
    if (numero_usuario > numero_generado):
      print("El numero que has introducido es mayor que el número generado. Sigue intentando.")
      intentos+=1
    elif (numero_usuario < numero_generado):
      print("El numero que has introducido es menor que el número generado. Sigue intentando.")
      intentos+=1
    else:
